"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[413],{2179:function(e,t,n){n.d(t,{Bt:function(){return sD},EK:function(){return P},ET:function(){return sS},IO:function(){return sa},JU:function(){return iV},PL:function(){return sT},QT:function(){return s_},Xo:function(){return sh},ad:function(){return iP},cf:function(){return sN},hJ:function(){return iL},oe:function(){return sA},pl:function(){return sI},r7:function(){return sC}});var r,i,s,a,o=n(7496),l=n(8828),u=n(8964),h=n(6077),c=n(8462),d=n(9598);n(5042);var f=n(6319).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n5(e){return new ni(e,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function s_(e){e=iN(e,iR);let t=iN(e.firestore,iF);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new im({next:o=>{s.Za(),t.enqueueAndForget(()=>rB(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rQ(e6(n.path),s,{includeMetadataChanges:!0,_a:!0});return rq(e,a)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(iU(t),e._key).then(n=>sb(t,e,n))}class sE extends sm{constructor(e){super(),this.firestore=e}convertBytes(e){return new iq(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iR(this.firestore,null,t)}}function sT(e){e=iN(e,iD);let t=iN(e.firestore,iF),n=iU(t),r=new sE(t);return sr(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new im({next:n=>{s.Za(),t.enqueueAndForget(()=>rB(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rQ(n,s,{includeMetadataChanges:!0,_a:!0});return rq(e,a)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sw(t,r,e,n))}function sI(e,t,n){e=iN(e,iR);let r=iN(e.firestore,iF),i=sp(e.converter,t,n);return sk(r,[iJ(iX(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tL.none())])}function sC(e,t,n,...r){e=iN(e,iR);let i=iN(e.firestore,iF),s=iX(i);return sk(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iB?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i9(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i9(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i7(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof iZ)u.push(t);else{let e=i1(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new ij(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);i3("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i6(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof iZ)s.push(o);else{let e=i1(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new ij(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tL.exists(!0))])}function sA(e){return sk(iN(e.firestore,iF),[new tK(e._key,tL.none())])}function sS(e,t){let n=iN(e.firestore,iF),r=iV(e),i=sp(e.converter,t);return sk(n,[iJ(iX(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tL.exists(!1))]).then(()=>r)}function sN(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iO(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iO(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iR)a=iN(e.firestore,iF),o=e6(e._key.path),s={next:n=>{t[u]&&t[u](sb(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iN(e,iD);a=iN(n.firestore,iF),o=n._query;let r=new sE(a);s={next:e=>{t[u]&&t[u](new sw(a,r,n,e))},error:t[u+1],complete:t[u+2]},sr(e._query)}return function(e,t,n,r){let i=new im(r),s=new rQ(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rq(await i_(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rB(await i_(e),s))}}(iU(a),o,c,s)}function sk(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r3(await iw(e).then(e=>e.syncEngine),t,n)),n.promise}(iU(e),t)}function sb(e,t,n){let r=n.docs.get(t._key),i=new sE(e);return new sy(e,i,t._key,r,new sg(n.hasPendingWrites,n.fromCache),t.converter)}function sD(){return new i0("serverTimestamp")}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iF(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);